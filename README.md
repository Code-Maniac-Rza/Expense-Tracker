...
The project was deployed using Github Pages. It can be seen [here]([https://github.com/Code-Maniac-Rza/Expense-Tracker](https://code-maniac-rza.github.io/Expense-Tracker/)).
